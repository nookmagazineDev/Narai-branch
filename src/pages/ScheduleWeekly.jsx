...
const POSITION_RANKS = [
  ...
  //
  // ใส่ตัวสะกดหลายแบบเพราะคนกรอกพิมพ์กันคนละอย่าง โดยเฉพาะ "เสิร์ฟ" ที่มีทั้งใส่และไม่ใส่
  // ไม้ทัณฑฆาต ("เสริฟ" "เสิฟ") — สะกดไม่ตรงสักตัวเดียวคนนั้นจะไปโผล่กลางตารางแทนที่จะอยู่ท้าย
  { rank: 70, keywords: ['กุ๊ก', 'กุ้ก', 'กุ๊ค', 'cook', 'เชฟ', 'chef'] },
  { rank: 80, keywords: ['บริการ', 'เสิร์ฟ', 'เสริฟ', 'เสิฟ', 'เสริ์ฟ', 'เสิรฟ', 'service', 'waiter', 'waitress'] },
  { rank: 90, keywords: ['ล้างจาน', 'ล้างชาม', 'ลางจาน', 'dish'] },
];
...
export default function ScheduleWeekly() {
  ...
  const calculateCellWage = (emp, data) => {
    ...
    if (isCellCleared(data)) {
      ...
      if (l2 !== '') {
        // ตัวเลือก "หยุด (ไม่รับค่าแรง)" ชุดใหม่ (10 หยุด / 18 ลาออก / 21 ป่วย / 22 กิจ / 23 ขาดงาน) ได้ค่าแรง 0 ทั้งหมด
