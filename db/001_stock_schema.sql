/* ============================================================================
   ...
   ไฟล์นี้เป็นส่วน "ข้อมูลที่สาขากรอก" เท่านั้น
   ส่วนรายการสินค้า (ชีท "item" กับ "ค่าเฉลี่ยยอดใช้ต่อหัว" ในไฟล์ BOM) อยู่ที่
   002_item_schema.sql — ต้องรันไฟล์นี้ก่อน เพราะไฟล์นั้นไม่ได้สร้าง database ให้
