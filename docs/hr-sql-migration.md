...
3. **login** — ต้องออกแบบเรื่องรหัสผ่านใหม่ ชีทเดิมเก็บเป็นข้อความล้วน
   ย้ายเข้า SQL ควรเปลี่ยนเป็นเก็บ hash ไปพร้อมกัน
4. **สต๊อก / ของเสีย / รับของ / ค่าใช้จ่าย / ปิดรอบสิ้นเดือน** — กลุ่มใหญ่สุด
