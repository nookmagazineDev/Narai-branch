...
| เขียนอะไร | เฉพาะแถวที่ค่าต่างจากของเดิมจริง ๆ — รอบที่ชีทไม่มีการแก้จะไม่มีคำสั่งเขียนสักคำสั่ง |
| สั่งเอง | action `syncItemRegistry` (สิทธิ์ `all` เท่านั้น) เมื่ออยากได้ของใหม่เดี๋ยวนี้ไม่รอรอบ |
