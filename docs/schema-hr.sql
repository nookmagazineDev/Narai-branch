/* ============================================================================
   *** เลิกใช้แล้ว *** ข้อมูล HR ย้ายไป MySQL แล้ว — ของที่ใช้จริงคือ docs/schema-hr-mysql.sql
   เก็บไฟล์นี้ไว้อ้างอิงตอนเทียบโครงสร้างเก่า/ใหม่ และเผื่อต้องกลับไปดูฝั่ง SQL Server เดิม
   (วิธีย้ายข้อมูลอยู่ที่ docs/hr-sql-migration.md หัวข้อ "ย้ายจาก SQL Server มา MySQL")
